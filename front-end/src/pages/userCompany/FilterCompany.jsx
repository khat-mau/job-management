...
const FilterCompany= () => {
    return(
        <Wrapper className="px-[10px] md:px-0"
                content=""
        > 
            <h1 className="font-bold text-[20px] md:text-[30px] px-[auto] md:px-[55px] py-[20px]">Company: High Tech </h1>
            <div className=" flex flex-row w-full md:w-[75%] px-[auto] md:px-[55px] py-[20px]">
                        <Search  dataFilters={[]} placeholder="Search name job or categories" width />
                            ...
                            >
                                ...
                                <div className="p-auto md:p-[20px] basis-[50%] md:basis-[55%] pl-[5px]" >
                                    ...
                                    <div className="flex py-[5px] md:py-0">
                                        ...
                                        <span className="text-[10px] md:text-[20px]">{job2.money}</span>
                                    </div>
                                    <div className="flex py-[5px] md:py-0 ">
                                        <HiLocationMarker className="max-w-[36px] max-h-[30px] mt-[3px]" />
                                        <h1> {job2.location}</h1>
