        ...
        >
            ...
            <div className="grid grid-flow-row grid-cols-1 gap-0 md:gap-[50px] my-0 md:my-[50px] md:grid-cols-3 px-0 md:px-[20px]">
                ...
                {companies.map((company, index) => (
                    <Link className="font-bold text-[15px] md:text-[16px] border-solid border-b md:border-2 border-[#ebebebf8] hover:bg-gray-500 flex flex-row items-center w-full md:h-[150px]"
                        to={company.href}
                        key={index}
